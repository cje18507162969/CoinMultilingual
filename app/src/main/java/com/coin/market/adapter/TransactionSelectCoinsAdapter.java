...
public class TransactionSelectCoinsAdapter extends RecyclerArrayAdapter<CoinEntity> {

    public TransactionSelectCoinsAdapter(Context context) {
        super(context);
    }
    ...
    private static class PicPersonViewHolder extends BaseViewHolder<CoinEntity> {
        ...
        public PicPersonViewHolder(ViewGroup parent) {
            super(parent, R.layout.item_transaction_select_layout);
