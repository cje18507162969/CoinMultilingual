...
import com.coin.market.wight.WheelSurf.RotateListener;
import com.coin.market.wight.WheelSurf.WheelSurfPanView;
...
public class WheelSurfView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if ( attrs != null ) {
           ...
           // try {
                mGoImgRes = typedArray.getResourceId(R.styleable.wheelSurf_goImg, 0);
//            } finally { //回收这个对象
//                typedArray.recycle();
//            }
            typedArray.recycle();
        ...
        if ( mGoImgRes == 0 ) {
            mStart.setImageResource(R.mipmap.node2);
        } else {
