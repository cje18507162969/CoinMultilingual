package com.coin.market.wight.gesture;
        ...
        if (mAnswerList.size() <= 0) {
            ...
            if (mChooseList.size() < mMinCount) {
                ...
                if (mOnLockResetListener != null) {
                    ...
                    //mOnLockVerifyListener.onSettingsSuccess(true, mAnswerList);
                }
...
//         * 设置密码成功的回调
//         */
//        void onSettingsSuccess(boolean success, ArrayList<Integer> integers);
