...
import com.coin.market.activity.mine.settlededit.SettledEditActivity;
...
import teng.wang.comment.retrofit.RxManager;
...
public class HomeFragment extends BaseFragment implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public List<MarketsDTO> list = new ArrayList<>();
    ...
    public View onCreateFragmentView(LayoutInflater inflater, ViewGroup viewGroup) {
        mHomeLayoutBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_home_layout, viewGroup, false);
    ...
    protected void onFragmentVisible() {
        ...
        try {
            ...
            if (null!=mHomeLayoutBinding){
                switch (StringUtils.getLanguageStatus()){
                    case 0:
                        mHomeLayoutBinding.appBarMain.homeShareButton.setBackgroundResource(R.mipmap.pic_home_sharefriends);
                        break;
                    case 1:
                        mHomeLayoutBinding.appBarMain.homeShareButton.setBackgroundResource(R.mipmap.pic_home_sharefriends_en);
                        break;
                    case 2:
                        mHomeLayoutBinding.appBarMain.homeShareButton.setBackgroundResource(R.mipmap.pic_home_sharefriends_ko);
                        break;
                    case 3:
                        mHomeLayoutBinding.appBarMain.homeShareButton.setBackgroundResource(R.mipmap.pic_home_sharefriends_ja);
                        break;
                }
...
//        }
    ...
    protected void setListener() {
        ...
        mHomeLayoutBinding.appBarMain.homeShareButton.setOnClickListener(this);
...
//                break;
            case R.id.home_realnameauthentication: // 实名认证
                ...
                break;
            case R.id.home_help_center_button: // 帮助中心
