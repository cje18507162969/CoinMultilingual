...
public class CoinsFragment extends BaseFragment implements View.OnClickListener {
    ...
    private CoinsFragmentViewModel homeViewModel;
    private FragmentCoinsLayoutBinding binding;
    private FragmentTransaction transaction;
    public static CoinsFragment getCoinsFragment() {
    ...
    protected void onFragmentFirstVisible() {
        homeViewModel = new CoinsFragmentViewModel(this, binding);
    ...
    public interface mOnClickCallback {
        ...
        void selectItem(String id, String name, String minNumb);
