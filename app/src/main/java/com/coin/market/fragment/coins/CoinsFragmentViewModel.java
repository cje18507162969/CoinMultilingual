package com.coin.market.fragment.coins;
...
public class CoinsFragmentViewModel extends BaseFragmentViewModel<CoinsFragment, FragmentCoinsLayoutBinding> {

    private CoinListSelAdapter adapter;

    public CoinsFragmentViewModel(CoinsFragment fragment, FragmentCoinsLayoutBinding binding) {
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (!EmptyUtil.isEmpty(getFragments().listener)){
                    getFragments().listener.selectItem(adapter.getItem(position).getCoinId()+"", adapter.getItem(position).getCoinName(),"");// adapter.getItem(position).getExport_min()
